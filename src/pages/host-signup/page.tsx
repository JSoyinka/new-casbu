...
export default function HostSignupPage() {
  ...
  const hostTypes = [
    {
      id: 'influencer',
      title: 'Influencer',
      description: 'Social media personality with a large following',
      icon: 'ri-star-line',
    },
    {
      id: 'expert',
      title: 'Expert',
      description: 'Professional with specialized knowledge',
      icon: 'ri-graduation-cap-line',
    },
    {
      id: 'creator',
      title: 'Content Creator',
      description: 'Artist, writer, or creative professional',
      icon: 'ri-palette-line',
    },
    {
      id: 'other',
      title: 'Other',
      description: 'Different type of creator or professional',
      icon: 'ri-user-line',
    },
  ];
  ...
  const engagementLevels = [
    {
      id: 'minimal',
      title: 'Minimal Engagement',
      description: 'Mostly automated responses, occasional personal touch',
    },
    {
      id: 'moderate',
      title: 'Moderate Engagement',
      description: 'Mix of automated and personal responses',
    },
    {
      id: 'high',
      title: 'High Engagement',
      description: 'Frequent personal interactions with subscribers',
    },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userProfile) {
        // Save pricing tiers only if at least one is filled
        const hasSubscriptionPricing =
          formData.tier1Price || formData.tier2Price || formData.tier3Price;
        if (hasSubscriptionPricing) {
          const pricingTiers = [];
          if (formData.tier1Price) {
            pricingTiers.push({
              user_id: userProfile.id,
              tier_level: 1,
              price: parseFloat(formData.tier1Price),
            });
          }
          if (formData.tier2Price) {
            pricingTiers.push({
              user_id: userProfile.id,
              tier_level: 2,
              price: parseFloat(formData.tier2Price),
            });
          }
          if (formData.tier3Price) {
            pricingTiers.push({
              user_id: userProfile.id,
              tier_level: 3,
              price: parseFloat(formData.tier3Price),
            });
          }
          if (pricingTiers.length > 0) {
            await supabase.from('pricing_tiers').insert(pricingTiers);
          }
        }

        // Save text message pricing only if at least one is filled
        const hasTextPricing =
          formData.simpleTextPrice || formData.complexTextPrice;
        if (hasTextPricing) {
          await supabase.from('text_message_pricing').insert({
            user_id: userProfile.id,
            simple_text_price: formData.simpleTextPrice
              ? parseFloat(formData.simpleTextPrice)
              : null,
            complex_text_price: formData.complexTextPrice
              ? parseFloat(formData.complexTextPrice)
              : null,
          });
        }
      ...
      <main className='pt-32 pb-24 px-4'>
            ...
            <div className='space-y-3'>
              {hostTypes.map((type) => (
                <button
                  key={type.id}
                  onClick={() =>
                    setFormData({ ...formData, hostType: type.id })
                  }
        ...
        {step === 4 && (
          <div>
            ...
            <p className='text-gray-400 mb-6'>
              Configure your virtual assistant to help manage interactions
            </p>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      assistantPersona: e.target.value,
                    })
                  }
                  rows={4}
                  className='w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                ...
                />
                <p className='text-xs text-gray-500 mt-1'>
                  {formData.assistantPersona.length}/500 characters
                </p>
              </div>
                ...
                <div className='space-y-3'>
                  {engagementLevels.map((level) => (
                    <button
                      key={level.id}
                      onClick={() =>
                        setFormData({ ...formData, engagementLevel: level.id })
                      }
                      className={`w-full p-4 rounded-xl border-2 text-left transition-all ${
        ...
        {step === 5 && (
          <div>
            ...
            <p className='text-gray-400 mb-6'>
              Choose at least one pricing method
            </p>
            ...
            {pricingTab === 'text' && (
              <div className='space-y-6'>
                <p className='text-gray-400 text-sm'>
                  Set prices for receiving text messages (optional - fill at
                  least one)
                </p>
                ...
                <div className='bg-gray-800 rounded-xl p-4 border border-gray-700'>
                  <div className='flex items-center space-x-3 mb-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-gray-400'>
                        Quick questions and simple replies
                      </p>
                    </div>
                  </div>
                  <div className='flex items-center space-x-2'>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          simpleTextPrice: e.target.value,
                        })
                      }
                ...
                <div className='bg-gray-800 rounded-xl p-4 border border-gray-700'>
                  <div className='flex items-center space-x-3 mb-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-gray-400'>
                        Detailed questions requiring longer responses
                      </p>
                    </div>
                  </div>
                  <div className='flex items-center space-x-2'>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          complexTextPrice: e.target.value,
                        })
                      }
                      className='flex-1 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                      placeholder='15.00'
            ...
            {pricingTab === 'subscription' && (
              <div className='space-y-6'>
                <p className='text-gray-400 text-sm'>
                  Configure subscription tiers (optional - fill at least one)
                </p>
                ...
                <div className='bg-gray-800 rounded-xl p-4 border border-gray-700'>
                  <div className='flex items-center space-x-3 mb-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-gray-400'>
                        Limited replies, weekly broadcasts
                      </p>
                    </div>
                  </div>
                  <div className='flex items-center space-x-2'>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, tier1Price: e.target.value })
                      }
                      className='flex-1 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                      placeholder='9.99'
                      step='0.01'
                ...
                <div className='bg-gray-800 rounded-xl p-4 border border-blue-500/30'>
                  <div className='flex items-center space-x-3 mb-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-gray-400'>
                        Occasional 1:1 access, monthly AMAs
                      </p>
                    </div>
                  </div>
                  <div className='flex items-center space-x-2'>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, tier2Price: e.target.value })
                      }
                      className='flex-1 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                      placeholder='19.99'
                      step='0.01'
                  ...
                  <div className='flex items-center space-x-3 mb-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-blue-100'>
                        Premium messaging, personalized attention
                      </p>
                    </div>
                  </div>
                  <div className='flex items-center space-x-2'>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, tier3Price: e.target.value })
                      }
        ...
        <div className='flex space-x-3'>
          ...
          <button
            ...
            disabled={
              ...
              (step === 4 &&
                (!formData.assistantPersona || !formData.engagementLevel)) ||
              (step === 5 &&
                !formData.tier1Price &&
                !formData.tier2Price &&
                !formData.tier3Price &&
                !formData.simpleTextPrice &&
                !formData.complexTextPrice) ||
              isSubmitting
            }
